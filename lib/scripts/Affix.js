...
class Affix extends Attribute {
   ...
   */
  getContainerHeight_() {
    return (core.isDocument(this.container) ?
        this.container.documentElement : this.container).clientHeight;
  }

  /**
   * Gets container document height.
   * @return {Number}
   */
  getContainerDocumentHeight_() {
    return domPosition.getDocumentSize(this.container).height;
  }

  /**
   * Gets container scroll top.
   * @return {Number}
   */
  getContainerScrollTop_() {
    return core.isDocument(this.container) ?
        this.container.defaultView.pageYOffset : this.container.scrollTop;
  }
  ...
  intersectBottomRegion() {
    ...
    return this.getContainerScrollTop_() + this.getContainerHeight_() >=
              this.getContainerDocumentHeight_() - this.offsetBottom;
  }
  ...
  intersectTopRegion() {
    ...
    return this.getContainerScrollTop_() <= this.offsetTop;
  }
