 ...
 * @suppress {checkTypes}
 */
Templates.List.__deltemplate_s45_4ac84340 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.List.__deltemplate_s45_4ac84340.soyTemplateName = 'Templates.List.__deltemplate_s45_4ac84340';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('List'), 'element', 0, Templates.List.__deltemplate_s45_4ac84340);
 ...
 * @suppress {checkTypes}
 */
Templates.List.__deltemplate_s53_605e1843 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.List.__deltemplate_s53_605e1843.soyTemplateName = 'Templates.List.__deltemplate_s53_605e1843';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('List.items'), '', 0, Templates.List.__deltemplate_s53_605e1843);
