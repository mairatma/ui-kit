...
Templates.List.items = function(opt_data, opt_ignored, opt_ijData) {
  ...
  for (var itemIndex5 = 0; itemIndex5 < itemListLen5; itemIndex5++) {
    ...
    output += ((itemData5.img) ? '<span class="list-image u-pull-left ' + soy.$$escapeHtmlAttribute(itemData5.img['class']) + '"><img src="' + soy.$$escapeHtmlAttribute(soy.$$filterNormalizeUri(itemData5.img.src)) + '"></span>' : '') + '<div class="list-main-content u-pull-left"><div class="list-text">' + soy.$$escapeHtml(itemData5.content) + '</div>' + ((itemData5.help) ? '<div class="list-help">' + soy.$$escapeHtml(itemData5.help) + '</div>' : '') + '</div></li>';
  }
