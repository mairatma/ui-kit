...
Templates.Modal.__deltemplate_s78_df8ef55a = function(opt_data, opt_ignored, opt_ijData) {
  opt_data = opt_data || {};
  return soydata.VERY_UNSAFE.ordainSanitizedHtml('<div id="' + soy.$$escapeHtmlAttribute(opt_data.id) + '" class="modal ' + soy.$$escapeHtmlAttribute(opt_data.elementClasses ? opt_data.elementClasses : '') + '  ' + soy.$$escapeHtmlAttribute(opt_data.visible ? '' : 'hidden') + '" data-component>' + soy.$$escapeHtml(opt_data.elementContent) + '</div>');
};
if (goog.DEBUG) {
 ...
 * @suppress {checkTypes}
 */
Templates.Modal.__deltemplate_s88_65c2d4d4 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Modal.__deltemplate_s88_65c2d4d4.soyTemplateName = 'Templates.Modal.__deltemplate_s88_65c2d4d4';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Modal.body'), 'element', 0, Templates.Modal.__deltemplate_s88_65c2d4d4);
 ...
 * @suppress {checkTypes}
 */
Templates.Modal.__deltemplate_s94_c9897a65 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Modal.__deltemplate_s94_c9897a65.soyTemplateName = 'Templates.Modal.__deltemplate_s94_c9897a65';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Modal.footer'), 'element', 0, Templates.Modal.__deltemplate_s94_c9897a65);
 ...
 * @suppress {checkTypes}
 */
Templates.Modal.__deltemplate_s100_499dc9aa = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Modal.__deltemplate_s100_499dc9aa.soyTemplateName = 'Templates.Modal.__deltemplate_s100_499dc9aa';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Modal.header'), 'element', 0, Templates.Modal.__deltemplate_s100_499dc9aa);
 ...
 * @suppress {checkTypes}
 */
Templates.Modal.__deltemplate_s106_45b138fb = function(opt_data, opt_ignored, opt_ijData) {
  opt_data = opt_data || {};
...
if (goog.DEBUG) {
  Templates.Modal.__deltemplate_s106_45b138fb.soyTemplateName = 'Templates.Modal.__deltemplate_s106_45b138fb';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Modal'), '', 0, Templates.Modal.__deltemplate_s106_45b138fb);
 ...
 * @suppress {checkTypes}
 */
Templates.Modal.__deltemplate_s112_90747620 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Modal.__deltemplate_s112_90747620.soyTemplateName = 'Templates.Modal.__deltemplate_s112_90747620';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Modal.body'), '', 0, Templates.Modal.__deltemplate_s112_90747620);
 ...
 * @suppress {checkTypes}
 */
Templates.Modal.__deltemplate_s117_231e36e7 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Modal.__deltemplate_s117_231e36e7.soyTemplateName = 'Templates.Modal.__deltemplate_s117_231e36e7';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Modal.footer'), '', 0, Templates.Modal.__deltemplate_s117_231e36e7);
 ...
 * @suppress {checkTypes}
 */
Templates.Modal.__deltemplate_s122_b8354b7d = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Modal.__deltemplate_s122_b8354b7d.soyTemplateName = 'Templates.Modal.__deltemplate_s122_b8354b7d';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Modal.header'), '', 0, Templates.Modal.__deltemplate_s122_b8354b7d);
