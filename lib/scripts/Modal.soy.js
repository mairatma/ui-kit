 ...
 * @suppress {checkTypes}
 */
Templates.Modal.__deltemplate_s43_77dbabf9 = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(Templates.Modal.content(opt_data, null, opt_ijData));
};
if (goog.DEBUG) {
  Templates.Modal.__deltemplate_s43_77dbabf9.soyTemplateName = 'Templates.Modal.__deltemplate_s43_77dbabf9';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Modal'), 'content', 0, Templates.Modal.__deltemplate_s43_77dbabf9);
 ...
 * @suppress {checkTypes}
 */
Templates.Modal.__deltemplate_s60_016394a5 = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(Templates.Modal.body(opt_data, null, opt_ijData));
};
if (goog.DEBUG) {
  Templates.Modal.__deltemplate_s60_016394a5.soyTemplateName = 'Templates.Modal.__deltemplate_s60_016394a5';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Modal.body'), 'content', 0, Templates.Modal.__deltemplate_s60_016394a5);
 ...
 * @suppress {checkTypes}
 */
Templates.Modal.__deltemplate_s69_ff0238db = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(Templates.Modal.footer(opt_data, null, opt_ijData));
};
if (goog.DEBUG) {
  Templates.Modal.__deltemplate_s69_ff0238db.soyTemplateName = 'Templates.Modal.__deltemplate_s69_ff0238db';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Modal.footer'), 'content', 0, Templates.Modal.__deltemplate_s69_ff0238db);
 ...
 * @suppress {checkTypes}
 */
Templates.Modal.__deltemplate_s71_b8354b7d = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Modal.__deltemplate_s71_b8354b7d.soyTemplateName = 'Templates.Modal.__deltemplate_s71_b8354b7d';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Modal.header'), '', 0, Templates.Modal.__deltemplate_s71_b8354b7d);
 ...
 * @suppress {checkTypes}
 */
Templates.Modal.__deltemplate_s78_7a6de6d1 = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(Templates.Modal.header(opt_data, null, opt_ijData));
};
if (goog.DEBUG) {
  Templates.Modal.__deltemplate_s78_7a6de6d1.soyTemplateName = 'Templates.Modal.__deltemplate_s78_7a6de6d1';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Modal.header'), 'content', 0, Templates.Modal.__deltemplate_s78_7a6de6d1);
