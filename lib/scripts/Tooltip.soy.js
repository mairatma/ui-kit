 ...
 * @suppress {checkTypes}
 */
Templates.Tooltip.__deltemplate_s83_8d49094e = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Tooltip.__deltemplate_s83_8d49094e.soyTemplateName = 'Templates.Tooltip.__deltemplate_s83_8d49094e';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Tooltip'), '', 0, Templates.Tooltip.__deltemplate_s83_8d49094e);
 ...
 * @suppress {checkTypes}
 */
Templates.Tooltip.__deltemplate_s89_5eaa83f8 = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(Templates.Tooltip.content(opt_data, null, opt_ijData));
};
if (goog.DEBUG) {
  Templates.Tooltip.__deltemplate_s89_5eaa83f8.soyTemplateName = 'Templates.Tooltip.__deltemplate_s89_5eaa83f8';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Tooltip'), 'content', 0, Templates.Tooltip.__deltemplate_s89_5eaa83f8);
 ...
 * @suppress {checkTypes}
 */
Templates.Tooltip.__deltemplate_s91_71828d2a = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.Tooltip.__deltemplate_s91_71828d2a.soyTemplateName = 'Templates.Tooltip.__deltemplate_s91_71828d2a';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('Tooltip'), 'element', 0, Templates.Tooltip.__deltemplate_s91_71828d2a);
