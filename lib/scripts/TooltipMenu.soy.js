...
Templates.TooltipMenu.__deltemplate_s124_270e148b = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(soy.$$getDelegateFn(soy.$$getDelTemplateId('ComponentElement'), 'TooltipMenu', true)(soy.$$augmentMap(opt_data, {elementContent: soydata.VERY_UNSAFE.$$ordainSanitizedHtmlForInternalBlocks('' + ((opt_ijData.renderChildComponents) ? Templates.TooltipMenu.content(opt_data, null, opt_ijData) : ''))}), null, opt_ijData));
};
if (goog.DEBUG) {
 ...
 * @suppress {checkTypes}
 */
Templates.TooltipMenu.__deltemplate_s130_da5bead2 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.TooltipMenu.__deltemplate_s130_da5bead2.soyTemplateName = 'Templates.TooltipMenu.__deltemplate_s130_da5bead2';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('ComponentElement'), 'TooltipMenu', 0, Templates.TooltipMenu.__deltemplate_s130_da5bead2);
