 ...
 * @suppress {checkTypes}
 */
Templates.TooltipMenu.__deltemplate_s173_cfc546d2 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.TooltipMenu.__deltemplate_s173_cfc546d2.soyTemplateName = 'Templates.TooltipMenu.__deltemplate_s173_cfc546d2';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('TooltipMenu'), 'element', 0, Templates.TooltipMenu.__deltemplate_s173_cfc546d2);
 ...
 * @suppress {checkTypes}
 */
Templates.TooltipMenu.__deltemplate_s181_c0ab3df3 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.TooltipMenu.__deltemplate_s181_c0ab3df3.soyTemplateName = 'Templates.TooltipMenu.__deltemplate_s181_c0ab3df3';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('TooltipMenu.items'), 'element', 0, Templates.TooltipMenu.__deltemplate_s181_c0ab3df3);
 ...
 * @suppress {checkTypes}
 */
Templates.TooltipMenu.__deltemplate_s187_8f8c631d = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.TooltipMenu.__deltemplate_s187_8f8c631d.soyTemplateName = 'Templates.TooltipMenu.__deltemplate_s187_8f8c631d';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('TooltipMenu'), '', 0, Templates.TooltipMenu.__deltemplate_s187_8f8c631d);
 ...
 * @suppress {checkTypes}
 */
Templates.TooltipMenu.__deltemplate_s193_f618b41e = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(Templates.TooltipMenu.content(opt_data, null, opt_ijData));
};
if (goog.DEBUG) {
  Templates.TooltipMenu.__deltemplate_s193_f618b41e.soyTemplateName = 'Templates.TooltipMenu.__deltemplate_s193_f618b41e';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('TooltipMenu'), 'content', 0, Templates.TooltipMenu.__deltemplate_s193_f618b41e);
 ...
 * @suppress {checkTypes}
 */
Templates.TooltipMenu.__deltemplate_s195_8278e063 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.TooltipMenu.__deltemplate_s195_8278e063.soyTemplateName = 'Templates.TooltipMenu.__deltemplate_s195_8278e063';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('TooltipMenu.items'), '', 0, Templates.TooltipMenu.__deltemplate_s195_8278e063);
 ...
 * @suppress {checkTypes}
 */
Templates.TooltipMenu.__deltemplate_s202_d55fbf7b = function(opt_data, opt_ignored, opt_ijData) {
  return soydata.VERY_UNSAFE.ordainSanitizedHtml(Templates.TooltipMenu.items(opt_data, null, opt_ijData));
};
if (goog.DEBUG) {
  Templates.TooltipMenu.__deltemplate_s202_d55fbf7b.soyTemplateName = 'Templates.TooltipMenu.__deltemplate_s202_d55fbf7b';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('TooltipMenu.items'), 'content', 0, Templates.TooltipMenu.__deltemplate_s202_d55fbf7b);
