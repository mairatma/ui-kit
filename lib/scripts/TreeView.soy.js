...
Templates.TreeView.nodes = function(opt_data, opt_ignored, opt_ijData) {
  var output = '';
  var nodeList184 = opt_data.nodes;
  var nodeListLen184 = nodeList184.length;
  for (var nodeIndex184 = 0; nodeIndex184 < nodeListLen184; nodeIndex184++) {
    var nodeData184 = nodeList184[nodeIndex184];
    var index__soy185 = nodeIndex184;
    output += soy.$$getDelegateFn(soy.$$getDelTemplateId('TreeView.node'), '', true)({id: opt_data.id, node: nodeData184, surfaceId: opt_data.parentSurfaceId != null ? opt_data.parentSurfaceId + '-' + index__soy185 : index__soy185}, null, opt_ijData);
  }
 ...
 * @suppress {checkTypes}
 */
Templates.TreeView.__deltemplate_s212_6f4f2112 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.TreeView.__deltemplate_s212_6f4f2112.soyTemplateName = 'Templates.TreeView.__deltemplate_s212_6f4f2112';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('TreeView.nodes'), 'element', 0, Templates.TreeView.__deltemplate_s212_6f4f2112);
 ...
 * @suppress {checkTypes}
 */
Templates.TreeView.__deltemplate_s220_68b4c502 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.TreeView.__deltemplate_s220_68b4c502.soyTemplateName = 'Templates.TreeView.__deltemplate_s220_68b4c502';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('TreeView.node'), 'element', 0, Templates.TreeView.__deltemplate_s220_68b4c502);
 ...
 * @suppress {checkTypes}
 */
Templates.TreeView.__deltemplate_s228_13da0f6e = function(opt_data, opt_ignored, opt_ijData) {
  opt_data = opt_data || {};
...
if (goog.DEBUG) {
  Templates.TreeView.__deltemplate_s228_13da0f6e.soyTemplateName = 'Templates.TreeView.__deltemplate_s228_13da0f6e';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('TreeView'), '', 0, Templates.TreeView.__deltemplate_s228_13da0f6e);
 ...
 * @suppress {checkTypes}
 */
Templates.TreeView.__deltemplate_s234_38810b2c = function(opt_data, opt_ignored, opt_ijData) {
  opt_data = opt_data || {};
...
if (goog.DEBUG) {
  Templates.TreeView.__deltemplate_s234_38810b2c.soyTemplateName = 'Templates.TreeView.__deltemplate_s234_38810b2c';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('TreeView'), 'element', 0, Templates.TreeView.__deltemplate_s234_38810b2c);
 ...
 * @suppress {checkTypes}
 */
Templates.TreeView.__deltemplate_s242_c801199b = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.TreeView.__deltemplate_s242_c801199b.soyTemplateName = 'Templates.TreeView.__deltemplate_s242_c801199b';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('TreeView.nodes'), '', 0, Templates.TreeView.__deltemplate_s242_c801199b);
 ...
 * @suppress {checkTypes}
 */
Templates.TreeView.__deltemplate_s247_f6fc17d6 = function(opt_data, opt_ignored, opt_ijData) {
...
if (goog.DEBUG) {
  Templates.TreeView.__deltemplate_s247_f6fc17d6.soyTemplateName = 'Templates.TreeView.__deltemplate_s247_f6fc17d6';
}
soy.$$registerDelegateFn(soy.$$getDelTemplateId('TreeView.node'), '', 0, Templates.TreeView.__deltemplate_s247_f6fc17d6);
