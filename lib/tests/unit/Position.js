...
describe('Position', function() {
  ...
  it('should try to align tooltip at right then move bottom', function() {
    mutable.style.left = (position.getViewportRegion().right - 50) + 'px';
  ...
  it('should try to align tooltip at bottom then move left', function() {
    mutable.style.bottom = position.getViewportRegion().bottom + 'px';
    mutable.style.top = (position.getViewportRegion().bottom - 50) + 'px';
