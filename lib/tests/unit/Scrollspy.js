...
describe('Scrollspy', function() {
  ...
  describe('Container', function () {
    before(function() {
      dom.enterDocument('<ul id="element"><li><a id="element1" href="#link1">link1</a></li><li><a id="element2" href="#link2">link2</a></li><li><a id="element3" href="#link3">link3</a></li><li><a id="element4" href="#link4">link4</a></li><li><a id="element5" href="#link5">link5</a></li></ul>');
  ...
  describe('Document', function () {
    before(function() {
      dom.enterDocument('<div id="scrollElement" style="position:relative;"><div id="link1" style="height:5000px;">Link1</div><div id="link2" style="height:5000px;">Link2</div><div id="link3" style="height:5000px;">Link3</div></div><div id="link4" style="height:5000px;">Link4</div></div>');
